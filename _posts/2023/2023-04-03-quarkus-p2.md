...
<br />
<h2>Application Secrets Management</h2>
...
<p style="text-align: justify;">Now, to access external services the book give some examples. One of them is using the client or MicroProfile Rest Client.</p>
...
<p style="text-align: justify;">Quarkus give support to the Spring libraries. You can use, for example, Spring DI that the application will have the same behave. The extenion to use Spring is <em>"spring-di"</em>.</p>
...
<br />
<h2>Working with a Reactive Programming Model</h2>
