...
<p><b>fs module</b>: provides APIs to deal with the business of reading, writing, file system meta-data and file system watching <a href="https://nodejs.org/docs/latest-v20.x/api/fs.html">[2]</a></p>
...
<p><u>4 Stream based</u>: It is good for large files. The fs module has createReadStream(createReadStream(__filename))<a href="https://nodejs.org/docs/latest-v20.x/api/fs.html#fscreatereadstreampath-options">[3]</a> and createWriteStream('out.txt')<a href="https://nodejs.org/docs/latest-v20.x/api/fs.html#filehandlecreatewritestreamoptions">[4]</a> methods to read and write files in chunks. The memory usage is constant as the file is read and write in small chunks. <a href="https://www.mariokandut.com/how-to-connect-streams-with-pipeline-in-node-js/?WT.mc_id=ravikirans">[5]</a><a href="https://codewinds.com/blog/2013-08-20-nodejs-transform-streams.html?WT.mc_id=ravikirans">[6]</a></p>

<p><b>Reading Directories</b>: it is a type of file. The fs module also provides multiple ways to read a directory: Synchronous, Callback-based, Promise-based. Ex: readdirSync, readdir<a href="https://nodejs.org/docs/latest-v20.x/api/fs.html#fspromisesreaddirpath-options">[7]</a> which list the files inside the folder.</p>

<p><b>File Metadata</b>: fs.stat, fs.statSync, fs/promises stat, fs.lstat, fs.lstatSync, fs/promises lstat. Ex: statSync(filename)</p>

<p><b>Watching:</b> fs.watch method is in Node core to tap into file system events.</p>
