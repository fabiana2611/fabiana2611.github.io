...
<p><em>The 'new' to create a buffer is deprecated. It used to have the Buffer.unsafeAlloc which means unallocated memory. The buffer can contain fragments of previously deleted data. It is used to performance porpose.</em></p>
