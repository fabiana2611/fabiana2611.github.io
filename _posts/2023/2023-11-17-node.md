...
<p>The <b>package-lock.json</b> file is used to install the exact same dependencies. It has the exact versions. </p>

<p><b>npm test</b> and <b>start</b> is alias to <b>npm run test</b> and <b>npm run start</b>.</p>

<p><b>SemVer:</b> the format is three numbers separated by dots (Major.Minor.Patch). The Major is the changes break, the Minor is add new something and the patch is bugfix. Ex: ^8.14.1 is the same 8.x.x and it means that will match MINOR and PATCH positions.</p>
...
<p>Examples of other way to tests: <a href="https://node-tap.org/">tap</a>, <a href="https://jasmine.github.io/">jasminie</a>, <a href="https://mochajs.org/">mocka</a>, <a href="https://jestjs.io/">jest</a>.</p>
