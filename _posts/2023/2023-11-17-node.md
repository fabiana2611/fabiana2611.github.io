...
<p>Event <a href="https://www.w3schools.com/nodejs/nodejs_events.asp">[1]</a><a href="https://www.geeksforgeeks.org/node-js-events/">[2]</a> is an action on a computer. It an be fire, create or listen by the Event Module. To assign an event you can use the EventEmitter object. </p>
...
myEmitter.on('error', ()=>{})                         // It make the process not crash
