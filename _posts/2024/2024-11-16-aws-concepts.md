...
<hr>
<br />
<h2 id="monitoring">Monitoring and Audit</h2>
...
<p style="text-align: justify;">The exam for Practitioner is not a big deal; however, there are a lot of services to remember what they mean. Generally, the exam will test you not so deeply but to see if you know what the services are and have a basic idea of where to use them. For Architecture the exame is more tyring. </p>

<p style="text-align: justify;">The courses I added here I consider complementary. After that, do a lot of simulations. The simulation will help you understand what the exam is really trying to test you on.</p>
