...
<ul>
	...
	<li>Tokens + Embeddings: Input Text > Tokens ("Create", "an", "image") > Each token is converted into a vector embeddings ("0.56","0.3","0.87") > Model Processing
</ul>
...
- Conversion rate: percentage of users who take a desired action. Effectiveness of driving desired outcomes. 
