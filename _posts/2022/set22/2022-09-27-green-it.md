...
<p style="text-align: justify;">As developers, some of the actions can seem distant from our day work. However, part of the action is directly related to our day-by-day. So, we can think of some more specific <b><a href="https://principles.green/">Principles</a></b> to guide us in our projects.</p>
...
<p style="text-align: justify;">Thinking further the programming activities, also the action can might be surround that. The start point can be the <b>choice of the computer</b>. The MAC, for instance, is committed with the <a href="https://www.apple.com/uk/environment/#reports-product">carbon neutral</a>. </p>
