...
<p style="text-align: justify;">The GSF has some <a href="https://greensoftware.foundation/projects">projects</a> in that direction. One of them is the <a href="https://greensoftware.foundation/articles/the-green-software-foundation-releases-alpha-version-of-software-carbon-intensity">Software Carbon Intensity (SCI) Specification</a>. The idea is <em>to describe a methodology for calculating the rate of carbon emissions for a software system</em>.</p>
