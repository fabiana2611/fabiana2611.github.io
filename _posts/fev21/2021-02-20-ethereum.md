...
<p style="text-align: justify;">To start your first steps in ethereum you can use the rinkeby network. First of all is to install the <a href="https://metamask.io/index.html">MetaMask</a> plugin. It allows the transactions from ethereum blockchain through regular websites. It uses a JavaScript library  (web3.js) to make it possible. You can have more then one account.</p>

<p style="text-align: justify;">Second step is to access the <a href="https://faucet.rinkeby.io/">faucet rinkeby</a> to require a temporary value of ethereum. You will need a tweeter or facebook account.</p>

<p style="text-align: justify;">After thar you are ready to test the transactions. Each one can be verified by rinkeby ethereum scan which will be available for you.</p>

<p style="text-align: justify;">As a extra point of test you can create a wallet in <a href="https://www.myetherwallet.com/">MEW</a>, select the rinkeby network and start the transactions betweent that and Metamask address.</p>

<p><center><img src="/img/blockchain/rinkeby.png" alt="rinkeby.png" width="744" height="512" /></center></p>
