...
<p>The basic concepts you can see int <a href="https://fabiana2611.github.io/java/books/quarkus">Quarkus - Part 1</a>.</p>
...
<p style="text-align: justify;">Another porpose is (2) to create an runnable JAR file. For that, it's necessary to use Quarkus Maven plug-in (>quarkus-maven-plugin).</p>
...
<p style="text-align: justify;">The health check to database is created automatically when the Quarkus is used to use it. It can be disabled by properties attibutes.</p>
