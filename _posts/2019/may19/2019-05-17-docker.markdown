...
<p style="text-align: justify;">If you don't want to install the docker but would like to test ir, you can use this <a href="https://labs.play-with-docker.com/">playground</a></p>
...
// local port 3000, docker port 80, detached, remove container when it is stopped, give a specific name
...
// see the logs, useful to detache mode than you cannot see the result in the terminal
...
$  docker run -d -p 3000:80 --rm --name feedback-app -v myfeedback:/app/feedback feedback-node:volumes 
...
-v "/Users/fabiana.araujo/Development/studies/docker/data-volumes-02-added-dockerfile:/app" \
